...
(function(){const p=window.location.pathname,ln=document.querySelectorAll(".nav-links a, .mobile-nav-links a"),isH=p.endsWith("/")||p.endsWith("index.html")||p.endsWith("index-en.html")||(!p.includes(".html")&&!p.includes("/blog/")&&!p.includes("/system/"));ln.forEach(a=>{const h=a.getAttribute("href");h&&(a.classList.remove("active"),!isH&&(p.includes("marketing")&&h.includes("marketing")?a.classList.add("active"):(p.includes("/blog/")||p.includes("/blog"))&&h.includes("blog/")?a.classList.add("active"):(p.includes("/system/")||p.includes("/system"))&&h.includes("system/")?a.classList.add("active"):""))}),isH&&(window.addEventListener("scroll",()=>{let sId="";const sPos=window.scrollY+200;document.querySelectorAll("section[id], header[id]").forEach(sec=>{sPos>=sec.offsetTop&&sPos<sec.offsetTop+sec.offsetHeight&&(sId=sec.getAttribute("id"))}),ln.forEach(a=>{const h=a.getAttribute("href");h&&(sId&&(h.endsWith("#"+sId)||h==="#"+sId)?a.classList.add("active"):(h.startsWith("#")||h.includes("#"))&&a.classList.remove("active"))})},{passive:true}),window.dispatchEvent(new Event("scroll")))})();