document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculate() {
        ...
        prevAvgLifetime.textContent = avgLifetimeMonths > 0 ? `${avgLifetimeMonths.toFixed(1)} شهر` : '∞';
