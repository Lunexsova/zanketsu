document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculateTotals() {
        ...
        rows.forEach(row => {
            const desc = row.querySelector('.item-desc').value || 'Service / Product';
    ...
    function createItemRow() {
        ...
        row.innerHTML = `
            <input type="text" class="form-control item-desc" placeholder="Service or Product description..." required>
            <input type="number" class="form-control item-price" placeholder="Price" min="0" step="0.01" placeholder="0.00" value="" required>
            <input type="number" class="form-control item-qty" placeholder="Qty" min="1" placeholder="1" value="" required>
