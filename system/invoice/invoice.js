document.addEventListener('DOMContentLoaded', () => {
    ...
    function createItemRow() {
        ...
        row.innerHTML = `
            ...
            <input type="number" class="form-control item-price" placeholder="السعر" min="0" step="0.01" placeholder="0.00" value="" required>
            <input type="number" class="form-control item-qty" placeholder="الكمية" min="1" placeholder="1" value="" required>
